...
export default function FeaturedCollections() {  
  ...
  return(
    <section className="featured-collections-section">   
      <h2 className="">Browse Our Puppy Collections</h2>
      <div className="collections-container">
       {collections.map((collection) => {
        return (
          <div className="collections-element" key={collection.key}>                     
            <img src={`https://donda-puppies-backend.onrender.com${item.product.images[0]}${collection.backgroundImage}`} alt="dog" className="collection-image" />
